...
type AvsRegistryService interface {
	...
	GetOperatorsAvsStateAtBlock(ctx context.Context, quorumNumbers []types.QuorumNum, blockNumber types.BlockNum) (map[types.OperatorAddr]types.OperatorAvsState, error)
